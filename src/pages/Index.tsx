...
const advantages = [
  {
    icon: "Unlock",
    title: "Устранение заклинивания",
    desc: "Устранение заклинивания валов без остановки грохота — оборудование продолжает работать в штатном режиме.",
  },
  {
    icon: "Settings",
    title: "Работа при отказе валов",
    desc: "Оборудование продолжает функционировать даже при выходе из строя до двух валов одновременно.",
  },
  {
    icon: "ShieldCheck",
    title: "Надёжность и отказоустойчивость",
    desc: "Высокая надежность и отказоустойчивость системы управления обеспечивает бесперебойную работу производства.",
  },
  {
    icon: "Network",
    title: "Интеграция в АСУ",
    desc: "Простая интеграция в существующие автоматизированные системы управления по протоколам ModBus TCP/RTU.",
  },
  {
    icon: "RotateCcw",
    title: "Дозапуск валов",
    desc: "Функция автоматического дозапуска валов после устранения неисправностей без полной перезагрузки системы.",
  },
  {
    icon: "Zap",
    title: "Защита электродвигателей",
    desc: "Эффективная защита электродвигателей приводов от перегрузок, коротких замыканий и перегрева.",
  },
];
